...
class SeleniumTest {
    ...
    void testSearchBar() throws InterruptedException {
        ...
        playerProfile.click();
        Thread.sleep(2000);
        WebElement playerRealName = webDriver.findElement(By.cssSelector("body > div.bgPadding > div > div.colCon > div.contentCol > div.playerProfile > div.playerContainer > div.playerName > div.playerRealname"));
    ...
    void testNavbarLinks() {
        ...
        WebElement navbar = webDriver.findElement(By.xpath("/html/body/div[1]/nav"));
    ...
    void testBestPlayer() throws InterruptedException {
        ...
        stats.click();
        WebElement bestPlayers = webDriver.findElement(By.cssSelector("body > div.bgPadding > div > div.colCon > div.contentCol > div.stats-section > div.stats-quick-navigation-container > a:nth-child(1)"));
        bestPlayers.click();
        ...
        WebElement bestPlayer = webDriver.findElement(By.cssSelector("body > div.bgPadding > div > div.colCon > div.contentCol > div.stats-section > table > tbody > tr:nth-child(1) > td.playerCol > a"));
    ...
    void applyForJob() throws InterruptedException {
        ...
        contact.click();
        Thread.sleep(1000);
        WebElement applyForJob = webDriver.findElement(By.cssSelector("body > div.bgPadding > div > div.colCon > div.contentCol > div.contact > div > div.g-grid.contact-nav > div:nth-child(5) > a"));
        applyForJob.click();
        Thread.sleep(1000);
